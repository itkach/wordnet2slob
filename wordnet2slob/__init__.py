...
class WordNet(object):
            ...
            for i, word in enumerate(words):
                ...
                for pointer in synset.pointers:
                    ...
                    try:
                        ...
                        print('WARNING: unknown pointer symbol %s for %s '
    ...
    def process(self):
        ...
        for title in self.collector:
            ...
            if text:
                self.slb.add(text.encode('utf-8'), title,
...
def parse_args():
    ...
    arg_parser.add_argument('-s', '--source-dir', type=str,
                            default='.',
                            help=('Path to WordNet source directory '
...
def main():
    ...
    if not os.path.exists(os.path.join(wordnetdir, 'dict')):
        print("%s doesn't contain dict subdirectory, "
